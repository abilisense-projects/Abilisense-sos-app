...
import { setUserData } from '../../actions/registerActions';
...
const SignUpScreen = ({ onStepChange }) => {
 ...
 //בדיקה האם האיימיל קיים בדאטא בייס אחרת זורק אימייל לא תקין/קיים
    // checkIfEmailExists(formData.email, "aviyariven@gmail.com");
    ...
    //לכתוב למשתמש שהאימייל אינו תקין - Invalid email
  }
...
//       // No errors, proceed to the next step
//       setErrors({});
//       setUserData(formData); // dispatch the user data to Redux
//       checkIfEmailExistsFunction(newStep);
//     } else {
//       // Validation failed, set the errors
//       setErrors(formErrors);
